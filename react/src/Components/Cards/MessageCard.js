  ...
  return (
    <Grid container sx={{ mb: 3 }} justifyContent={isMe ? 'flex-end' : 'flex-start'} >
      ...
      <Grid item xs={12} sx={{ mt: 1 }} >
        <HyperTypography variant="body1" fontSize={14} style={{whiteSpace:'pre-wrap',overflowWrap: 'break-word'}} color={theme.palette.chatText} align={isMe ? 'right':'left'} fontWeight={400} lineHeight={1.4}>
          {urlify(message)}
        </HyperTypography>
      </Grid>
    </Grid>
