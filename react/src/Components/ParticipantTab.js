    ...
    return (
        <div id={"admin-button-group-" + streamId}>
          {(role === WebinarRoles.ActiveHost ||
              role === WebinarRoles.ActiveSpeaker ||
          ...
          conference?.isAdmin === true ? (
              <PinBtn
                  ...
                  onClick={() => {
                    conference?.makeParticipantUndoPresenter(publishStreamId);
                  }}
              >
                {conference?.presenterButtonStreamIdInProcess.includes(publishStreamId) ? (
          ...
          conference?.isAdmin === true ? (
              <PinBtn
                  ...
                  sx={{ width: 28, pt: 1, pb: 1 }}
                  onClick={() => {
                    conference?.makeParticipantPresenter(publishStreamId);
                  }}
              >
                {conference?.presenterButtonStreamIdInProcess.includes(publishStreamId) ? (
                    <CircularProgress size={15} />
          ...
          {(role === WebinarRoles.TempListener || role === WebinarRoles.ActiveTempListener) &&
          conference?.isAdmin === true &&
        ...
        >
          ...
          <Grid item>
            <div style={{ display: "flex" }}>
              {typeof conference.allParticipants[streamId]?.isPinned !== "undefined" &&
              conference.allParticipants[streamId]?.isPinned === true ? (
                  <PinBtn
                      id={"unpin-" + streamId}
                      sx={{ minWidth: "unset", pt: 1, pb: 1 }}
                      onClick={() => {
