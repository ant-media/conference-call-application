    ...
    <>
      ...
      >
        ...
        <MenuItem onClick={() => handleGeneralSettingsDialogOpen()}>
          <ListItemIcon>
            <SvgIcon size={36} name={"settings"} color={theme.palette.iconColor}/>
          </ListItemIcon>
          <ListItemText
            id="general-button"
          >
        ...
        <MenuItem onClick={() => handleLayoutDialogOpen()} id="change-layout-button">
          <ListItemIcon>
            <SvgIcon size={36} name={"layout"} color={theme.palette.iconColor}/>
          </ListItemIcon>
          <ListItemText>
            {t("Change Layout")}
          </ListItemText>
        ...
        && process.env.REACT_APP_OPTION_MENU_CALL_SETTINGS_BUTTON_VISIBILITY === 'true' ?
          <MenuItem onClick={() => handleDialogOpen()}>
            <ListItemIcon>
              <SvgIcon size={36} name={"call-settings"} color={theme.palette.iconColor}/>
            </ListItemIcon>
        ...
        && process.env.REACT_APP_CALL_SETTINGS_VIRTUAL_BACKGROUND_MODE_VISIBILITY === 'true' ?
            <MenuItem onClick={() => { conference.handleEffectsOpen(!conference.effectsDrawerOpen); handleClose(); }}>
              <ListItemIcon>
                <SvgIcon size={36} name={"background-replacement"} color={theme.palette.iconColor} />
              </ListItemIcon>
        ...
        {process.env.REACT_APP_RECORDING_MANAGED_BY_ADMIN === 'false' || conference.isAdmin === true ?
          [
            ...
            >
              <ListItemIcon>
                <SvgIcon size={36} name={"camera"} color={theme.palette.iconColor} />
              </ListItemIcon>
        ...
        {process.env.REACT_APP_OPTION_MENU_REPORT_PROBLEM_BUTTON_VISIBILITY === 'true' ?
          ...
          >
            <ListItemIcon>
              <SvgIcon size={36} name={"report"} color={theme.palette.iconColor}/>
            </ListItemIcon>
